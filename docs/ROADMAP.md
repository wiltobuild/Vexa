...
| 3 Permissions & social | Roles/overrides, invites, friends/DMs, moderation, audit | Table-driven permission tests; denied-access test for every route/dispatch | Permission calculator and route/dispatch checks implemented; full social/moderation and denied-access matrix open. |
